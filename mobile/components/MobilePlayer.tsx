...
/* eslint-disable react-hooks/immutability -- audio is an HTMLAudioElement prop; mutating .currentTime is DOM manipulation, not React state mutation */
  ...
  return (
    <div className="mobile-player-full">
      ...
      <div className="mobile-player-full-info">
        <h2 className="mobile-player-full-title">{track.title || 'Unknown'}</h2>
